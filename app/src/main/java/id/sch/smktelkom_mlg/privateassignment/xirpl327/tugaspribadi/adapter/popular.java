...
public class popular extends RecyclerView.Adapter<popular.MyViewHolder> {
    ...
    public popular(PopularFragment popularFragment, ArrayList<Results> mlist, Context context) {
        this.mlist = mlist;
    ...
    @Override
    public popular.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(popular.MyViewHolder holder, int position) {
