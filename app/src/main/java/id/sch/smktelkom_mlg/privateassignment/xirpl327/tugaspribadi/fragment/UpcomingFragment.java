package id.sch.smktelkom_mlg.privateassignment.xirpl327.tugaspribadi.fragment;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl327.tugaspribadi.adapter.upcoming;
...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.rv_recycler_view_upcom);
        rv.setHasFixedSize(true);
        myUpcom = new upcoming(this, mlist, getContext());
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=f5203c197b2af435b78315acb9ae10b6&language=en-US&page=1";
